...
static void video_flow_help(char* cmd)
{
...
int main(int argc, char** argv)
{
    ...
    VideoFlowNetwork flow_net;
    // int network
    {
        flow_net.init(device_no);
    }
    ...
    for (int i = optind; i < argc; i++) {
        ...
        video_flow_predict(&flow_net, argv[i], second_file, output_filename);
    }
